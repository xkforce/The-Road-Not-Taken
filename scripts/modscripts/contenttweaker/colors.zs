...
for color in oreColors {
    ...
    val nugget as IItemStack = itemUtils.getItem("contenttweaker:" + c + "dyenugget");
    val block as IItemStack = itemUtils.getItem("contenttweaker:" + c + "dyeblock");
    ...
    for key in ["sparkler", "feather"] {
        ...
        val item as IItemStack = itemUtils.getItem(itemName);
