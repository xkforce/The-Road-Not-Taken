...
/*
    ...
    This script teleports the player to dimension -14 if they are below y = 0 and not in the end dimension.
*/
...
events.onPlayerTick(function(event as PlayerTickEvent) {
    ...
    // teleport player to dimension -14 if they are below y = 0
    if (event.player.y < 0) {
