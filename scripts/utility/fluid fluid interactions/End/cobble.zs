...
.addEvent(FITweaker.eventBuilder().createSetBlockEvent(<blockstate:contenttweaker:fayalite>).addCondition(Condition.byChance, [0.4f]).addCondition(Condition.biome, ["minecraft:sky"])));
